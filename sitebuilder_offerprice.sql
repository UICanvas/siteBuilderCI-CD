...
CREATE TABLE `offerprice` (
  ...
  UNIQUE KEY `UK_OFFERPRICE` (`OFFER_ID`,`CURRENCY`),
  CONSTRAINT `FK_OFFERPRICE_1` FOREIGN KEY (`OFFER_ID`) REFERENCES `offer` (`OFFER_ID`) ON DELETE CASCADE
